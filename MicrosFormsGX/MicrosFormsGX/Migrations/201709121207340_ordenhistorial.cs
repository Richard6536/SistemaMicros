namespace MicrosFormsGX.Migrations
{
    ...
    public partial class ordenhistorial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CalificacionDiaria = c.Single(nullable: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Coordenada", t => t.CoordenadaId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        DistanciaEntre = c.Double(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Estado = c.String(),
                        HoraCreacion = c.DateTime(nullable: false),
                        LatitudCreacion = c.Double(nullable: false),
                        LongitudCreacion = c.Double(nullable: false),
                        ParaderoId = c.Int(nullable: false),
                        MicroId = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.Micro", t => t.MicroId, cascadeDelete: true)
                .ForeignKey("dbo.Paradero", t => t.ParaderoId, cascadeDelete: true)
                .ForeignKey("dbo.Usuario", t => t.PasajeroId, cascadeDelete: true)
                .Index(t => t.ParaderoId)
                .Index(t => t.MicroId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MicroPasajero", "PasajeroId", "dbo.Usuario");
            DropForeignKey("dbo.MicroPasajero", "ParaderoId", "dbo.Paradero");
            DropForeignKey("dbo.MicroPasajero", "MicroId", "dbo.Micro");
            ...
            DropForeignKey("dbo.Paradero", "CoordenadaId", "dbo.Coordenada");
            ...
            DropIndex("dbo.MicroPasajero", new[] { "PasajeroId" });
            DropIndex("dbo.MicroPasajero", new[] { "MicroId" });
            DropIndex("dbo.MicroPasajero", new[] { "ParaderoId" });
            ...
            DropIndex("dbo.Paradero", new[] { "CoordenadaId" });
