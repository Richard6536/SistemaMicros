...
{
    [Activity(Label = "AndroidMicros", MainLauncher = true, Icon = "@drawable/icon")]
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            btnIngresar.Click += delegate {
                ...
                if(ingresoDatos == "correcto")
                {
                    ...
                    intent.PutExtra(UserActivity.LLAVE_NOMBRE, txtNombre.Text); //Envío de información a través de la llave creada
